...
Revision ID: 4abcd9ca6607
Revises: 
Create Date: 2026-08-13 19:40:56.010783
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_game_session_id'), 'game_session', ['id'], unique=True)
    ...
    sa.ForeignKeyConstraint(['guest_id'], ['guest.id'], ),
    sa.PrimaryKeyConstraint('guest_id', 'game_session_id')
    )
