...
Revision ID: 876b506e1011
Revises: 
Create Date: 2026-08-13 16:34:12.041826
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_offline_game_session_id'), 'offline_game_session', ['id'], unique=True)
    ...
    op.create_table('guests_game_offline_session',
    sa.Column('guest_id', sa.UUID(), nullable=False),
    sa.Column('offline_game_session_id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['guest_id'], ['guest.id'], ),
...
def downgrade() -> None:
    ...
    op.drop_table('guests_game_offline_session')
